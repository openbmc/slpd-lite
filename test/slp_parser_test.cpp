...
TEST(parseSrvRqst, GoodPathWithData)
{
    ...
    slp::buffer testData{0x00,0x09,0x00,0x00,
                         ...
                         'S','C','O','P',
                         'E',
                         0x00, 0x02,    /* predicate length */
                         'P','D',
                         0x00, 0x01,    /* SLP SPI length */
                         'S'};
    slp::Message req;
    int rc = slp::SUCCESS;
    std::tie(rc, req) = slp::parser::internal::parseHeader(testData);
...
{
    // This matches what "slptool -u <server> findsrvs service:obmc_console" sends
    slp::buffer testData{0x02,0x01,0x00,0x00,
                         0x35,0x00,0x00,0x00,
                         0x00,0x00,0xe5,0xc2,
                         0x00,0x02,     /* Lang Length */
                         'e','n',
                         0x00,0x00,     /* PR list length*/
