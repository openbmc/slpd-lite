...
std::tuple<int, Message> parseBuffer(const slp::buffer& buf);
...
std::tuple<int, Message> parseHeader(const slp::buffer& buf);
...
int parseSrvTypeRqst(const slp::buffer& buf, slp::Message& req);
...
int parseSrvRqst(const slp::buffer& buf, slp::Message& req);
...
std::tuple<int, buffer> processRequest(const slp::Message& msg);
...
buffer processError(const slp::Message& req,
                    const uint8_t err);
namespace internal
{
...
std::tuple<int, buffer> processSrvRequest(const slp::Message& msg);
...
std::tuple<int, buffer> processSrvTypeRequest(const slp::Message& msg);
 ...
 * @internal
 */
buffer prepareHeader(const slp::Message& req);
