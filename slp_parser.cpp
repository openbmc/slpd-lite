...
int parseSrvTypeRqst(const buffer& buff, Message& req)
{
    ...
    {
        std::cout << "PRList length field is greater then input buffer: "
    ...
    {
        std::cout << "Length of PRList is greater then input buffer: "
    ...
    req.body.srvtyperqst.prList.insert(
        0, (const char*)buff.data() + pos, prListLen);
    ...
    {
        std::cout << "Naming auth length field is greater then input buffer: "
    ...
    else
    {
        ...
        {
            std::cout << "Length of Naming Size is greater then input buffer: "
    ...
    {
        std::cout << "Length of Scope suze is greater then input buffer: "
    ...
    {
        std::cout << "Length of Scope List is greater then input buffer: "
